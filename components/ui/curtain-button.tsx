...
const CurtainButton = React.forwardRef<HTMLButtonElement, CurtainButtonProps>(
  (
    ...
    const variantStyles = {
      ...
      emerald: {
        button: 'bg-emerald-500/80 border border-emerald-400/30 text-white',
        curtain: 'bg-white',
        textInitial: 'text-white',
        textHover: 'text-emerald-600',
      },
      amber: {
        button: 'bg-amber-500/80 border border-amber-400/30 text-white',
        curtain: 'bg-white',
        textInitial: 'text-white',
        textHover: 'text-amber-600',
      },
      purple: {
        button: 'bg-purple-500/80 border border-purple-400/30 text-white',
        curtain: 'bg-white',
        textInitial: 'text-white',
    ...
    return (
      <motion.button
        ref={ref}
        className={cn(
          'relative overflow-hidden rounded-lg font-medium ring-offset-background transition-colors',
