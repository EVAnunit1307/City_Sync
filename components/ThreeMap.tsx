...
> {
  try {
    ...
    const response = await fetch(
      `/api/map/traffic-signals?south=43.851&west=-79.278&north=43.871&east=-79.248`,
      {
  ...
  useEffect(() => {
    ...
    async function initializeScene() {
      ...
      try {
        ...
        // Define bounding box for Markham area
        const bbox: [number, number, number, number] = [
          43.851, -79.278, 43.871, -79.248,
        ];
        ...
        // Fly to Markham center coordinates
        await flyToLocation(
          camera,
          controls,
          [-79.2666, 43.8643],
